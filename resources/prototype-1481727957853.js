(function(window, undefined) {
  var dictionary = {
    ...
    "71389cd5-6a30-4a44-921a-4a15fe9caf6c": "Disciplines",
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/71389cd5-6a30-4a44-921a-4a15fe9caf6c",
                    "transition": "fade"
                  },
                  "exectype": "serial",
                  "delay": 0
  ...
  .on("click", ".s-71389cd5-6a30-4a44-921a-4a15fe9caf6c .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
